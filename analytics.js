...
require.register("segmentio-utm-params/index.js", function(exports, require, module){
...
require.register("yields-send-json/index.js", function(exports, require, module){
/**
 * Module dependencies.
 */
...
require.register("bigcommerce-labs-analytics.js-integrations/index.js", function(exports, require, module){
...
require.register("bigcommerce-labs-analytics.js-integrations/lib/fornax.js", function(exports, require, module){
var integration = require('integration');
var load = require('load-script');

module.exports = exports = function (analytics) {
  analytics.addIntegration(Fornax);
};
...
Fornax.prototype.initialize = function() {
  var options = this.options;
  var self = this;
  this.load(function() {
    self.debug('initialize fornax');
    window.Fornax.set(options);
    self.emit('ready');
  });
};

Fornax.prototype.loaded = function() {
  return !!window.Fornax;
};

Fornax.prototype.identify = function(identify) {
  ...
  window.Fornax.identify(id, traits);
};

Fornax.prototype.track = function(track) {
  var event = track.event(),
  ...
  window.Fornax.track(event, properties);
};

Fornax.prototype.alias = function(alias) {
  var to = alias.to(),
      from = alias.from();
  this.debug('alias', {
    to: to,
  ...
  window.Fornax.alias(to, from);
};
});
require.register("bigcommerce-labs-analytics.js-integrations/lib/segmentio.js", function(exports, require, module){
var i = module, t = require;

function n() {
    return "http:" == document.location.protocol ? "http:" : "https:"
}
function o() {}
var a = t("integration"),
    r = t("top-domain");
...
var d = e.Integration = a("Segment.io").readyOnInitialize().option("apiKey", "");
...
d.prototype.identify = function (e) {
    this.send("/i", e.json())
};
d.prototype.group = function (e) {
    this.send("/g", e.json())
};
d.prototype.track = function (e) {
    var t = e.json();
    delete t.traits;
    this.send("/t", t)
};
d.prototype.alias = function (e) {
    var t = e.json(),
        i = this.session();
    t.from = t.from || i.id || i.sid;
    this.send("/a", t)
};
d.prototype.session = function (e) {
    ...
    a.id = e;
    i = [a.sid, a.id].join("----");
    this.debug('cookie "_sio", %o, domain: %s, path: %s', i, t, "/");
    l("_sio", i, {
        domain: t,
        maxage: 18e5,
        secure: !1,
...
d.prototype.normalize = function (e) {
    ...
    var t = window.location.search,
        i = this.session();
    e.userId && (i = this.session(e.userId));
    !e.userId && i.id && (e.userId = i.id);
    var n = e.context = e.context || e.options || {};
    delete e.options;
...
d.prototype.send = function (e, t, i) {
...
require.register("bigcommerce-labs-analytics.js-integrations/lib/slugs.json", function(exports, require, module){
module.exports = [
  "fornax",
  "segmentio"
]
...
require.alias("bigcommerce-labs-analytics.js-integrations/index.js", "analytics/deps/integrations/index.js");
require.alias("bigcommerce-labs-analytics.js-integrations/lib/fornax.js", "analytics/deps/integrations/lib/fornax.js");
require.alias("bigcommerce-labs-analytics.js-integrations/lib/segmentio.js", "analytics/deps/integrations/lib/segmentio.js");
require.alias("bigcommerce-labs-analytics.js-integrations/index.js", "integrations/index.js");
require.alias("component-clone/index.js", "bigcommerce-labs-analytics.js-integrations/deps/clone/index.js");
require.alias("component-type/index.js", "component-clone/deps/type/index.js");

require.alias("component-domify/index.js", "bigcommerce-labs-analytics.js-integrations/deps/domify/index.js");

require.alias("component-each/index.js", "bigcommerce-labs-analytics.js-integrations/deps/each/index.js");
require.alias("component-type/index.js", "component-each/deps/type/index.js");

require.alias("component-once/index.js", "bigcommerce-labs-analytics.js-integrations/deps/once/index.js");

require.alias("component-type/index.js", "bigcommerce-labs-analytics.js-integrations/deps/type/index.js");

require.alias("component-url/index.js", "bigcommerce-labs-analytics.js-integrations/deps/url/index.js");

require.alias("ianstormtaylor-callback/index.js", "bigcommerce-labs-analytics.js-integrations/deps/callback/index.js");
require.alias("timoxley-next-tick/index.js", "ianstormtaylor-callback/deps/next-tick/index.js");

require.alias("ianstormtaylor-bind/index.js", "bigcommerce-labs-analytics.js-integrations/deps/bind/index.js");
require.alias("component-bind/index.js", "ianstormtaylor-bind/deps/bind/index.js");
...
require.alias("ianstormtaylor-is/index.js", "bigcommerce-labs-analytics.js-integrations/deps/is/index.js");
require.alias("component-type/index.js", "ianstormtaylor-is/deps/type/index.js");

require.alias("ianstormtaylor-is-empty/index.js", "ianstormtaylor-is/deps/is-empty/index.js");

require.alias("segmentio-alias/index.js", "bigcommerce-labs-analytics.js-integrations/deps/alias/index.js");
...
require.alias("segmentio-analytics.js-integration/lib/index.js", "bigcommerce-labs-analytics.js-integrations/deps/integration/lib/index.js");
require.alias("segmentio-analytics.js-integration/lib/protos.js", "bigcommerce-labs-analytics.js-integrations/deps/integration/lib/protos.js");
require.alias("segmentio-analytics.js-integration/lib/events.js", "bigcommerce-labs-analytics.js-integrations/deps/integration/lib/events.js");
require.alias("segmentio-analytics.js-integration/lib/statics.js", "bigcommerce-labs-analytics.js-integrations/deps/integration/lib/statics.js");
require.alias("segmentio-analytics.js-integration/lib/index.js", "bigcommerce-labs-analytics.js-integrations/deps/integration/index.js");
...
require.alias("segmentio-canonical/index.js", "bigcommerce-labs-analytics.js-integrations/deps/canonical/index.js");

require.alias("segmentio-convert-dates/index.js", "bigcommerce-labs-analytics.js-integrations/deps/convert-dates/index.js");
...
require.alias("segmentio-extend/index.js", "bigcommerce-labs-analytics.js-integrations/deps/extend/index.js");

require.alias("segmentio-facade/lib/index.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/index.js");
require.alias("segmentio-facade/lib/alias.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/alias.js");
require.alias("segmentio-facade/lib/facade.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/facade.js");
require.alias("segmentio-facade/lib/group.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/group.js");
require.alias("segmentio-facade/lib/page.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/page.js");
require.alias("segmentio-facade/lib/identify.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/identify.js");
require.alias("segmentio-facade/lib/is-enabled.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/is-enabled.js");
require.alias("segmentio-facade/lib/track.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/lib/track.js");
require.alias("segmentio-facade/lib/index.js", "bigcommerce-labs-analytics.js-integrations/deps/facade/index.js");
...
require.alias("segmentio-global-queue/index.js", "bigcommerce-labs-analytics.js-integrations/deps/global-queue/index.js");

require.alias("segmentio-is-email/index.js", "bigcommerce-labs-analytics.js-integrations/deps/is-email/index.js");

require.alias("segmentio-load-date/index.js", "bigcommerce-labs-analytics.js-integrations/deps/load-date/index.js");

require.alias("segmentio-load-script/index.js", "bigcommerce-labs-analytics.js-integrations/deps/load-script/index.js");
require.alias("component-type/index.js", "segmentio-load-script/deps/type/index.js");

require.alias("segmentio-script-onload/index.js", "bigcommerce-labs-analytics.js-integrations/deps/script-onload/index.js");
require.alias("segmentio-script-onload/index.js", "bigcommerce-labs-analytics.js-integrations/deps/script-onload/index.js");
require.alias("segmentio-script-onload/index.js", "segmentio-script-onload/index.js");
require.alias("segmentio-on-body/index.js", "bigcommerce-labs-analytics.js-integrations/deps/on-body/index.js");
require.alias("component-each/index.js", "segmentio-on-body/deps/each/index.js");
require.alias("component-type/index.js", "component-each/deps/type/index.js");

require.alias("segmentio-on-error/index.js", "bigcommerce-labs-analytics.js-integrations/deps/on-error/index.js");

require.alias("segmentio-to-iso-string/index.js", "bigcommerce-labs-analytics.js-integrations/deps/to-iso-string/index.js");

require.alias("segmentio-to-unix-timestamp/index.js", "bigcommerce-labs-analytics.js-integrations/deps/to-unix-timestamp/index.js");

require.alias("segmentio-use-https/index.js", "bigcommerce-labs-analytics.js-integrations/deps/use-https/index.js");

require.alias("segmentio-when/index.js", "bigcommerce-labs-analytics.js-integrations/deps/when/index.js");
require.alias("ianstormtaylor-callback/index.js", "segmentio-when/deps/callback/index.js");
require.alias("timoxley-next-tick/index.js", "ianstormtaylor-callback/deps/next-tick/index.js");

require.alias("timoxley-next-tick/index.js", "bigcommerce-labs-analytics.js-integrations/deps/next-tick/index.js");

require.alias("segmentio-top-domain/index.js", "bigcommerce-labs-analytics.js-integrations/deps/top-domain/index.js");
require.alias("segmentio-top-domain/index.js", "bigcommerce-labs-analytics.js-integrations/deps/top-domain/index.js");
...
require.alias("segmentio-utm-params/index.js", "bigcommerce-labs-analytics.js-integrations/deps/utm-params/index.js");
require.alias("segmentio-utm-params/index.js", "bigcommerce-labs-analytics.js-integrations/deps/utm-params/index.js");
...
require.alias("segmentio-utm-params/index.js", "segmentio-utm-params/index.js");
require.alias("yields-send-json/index.js", "bigcommerce-labs-analytics.js-integrations/deps/send-json/index.js");
require.alias("yields-send-json/index.js", "bigcommerce-labs-analytics.js-integrations/deps/send-json/index.js");
...
require.alias("yields-send-json/index.js", "yields-send-json/index.js");
require.alias("yields-slug/index.js", "bigcommerce-labs-analytics.js-integrations/deps/slug/index.js");

require.alias("component-cookie/index.js", "bigcommerce-labs-analytics.js-integrations/deps/cookie/index.js");

require.alias("gjohnson-uuid/index.js", "bigcommerce-labs-analytics.js-integrations/deps/uuid/index.js");

require.alias("visionmedia-batch/index.js", "bigcommerce-labs-analytics.js-integrations/deps/batch/index.js");
require.alias("component-emitter/index.js", "visionmedia-batch/deps/emitter/index.js");
require.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

require.alias("visionmedia-debug/index.js", "bigcommerce-labs-analytics.js-integrations/deps/debug/index.js");
require.alias("visionmedia-debug/debug.js", "bigcommerce-labs-analytics.js-integrations/deps/debug/debug.js");

require.alias("segmentio-load-pixel/index.js", "bigcommerce-labs-analytics.js-integrations/deps/load-pixel/index.js");
require.alias("segmentio-load-pixel/index.js", "bigcommerce-labs-analytics.js-integrations/deps/load-pixel/index.js");
...
require.alias("segmentio-replace-document-write/index.js", "bigcommerce-labs-analytics.js-integrations/deps/replace-document-write/index.js");
require.alias("segmentio-replace-document-write/index.js", "bigcommerce-labs-analytics.js-integrations/deps/replace-document-write/index.js");
